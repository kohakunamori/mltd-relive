各位好！这个仓库是我个人创建的一个分支，考虑原项目已经许久没有更新，继而尝试继续进行一些Standalone版本的支持工作。

目前这个仓库主要基于原仓库的Standalone v0.1.2，支持了以下功能（简体字部分为新支持的功能）：
...
- 剧情
   - 主线故事
   - 偶像觉醒&服装故事
   - 活动故事（除MILLION LIVE WORKING外）
   - 其它
   - 特别
- 礼物的领取

目前新适配的功能里，涉及到随机性的部分，虽然个人也有在日服进行测试和数据收集，不过目前样本量还较少，所以概率还是参考wiki乱填的）请各位见谅
