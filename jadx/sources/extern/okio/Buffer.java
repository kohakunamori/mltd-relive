...
public final class Buffer implements BufferedSink, BufferedSource, Cloneable, ByteChannel {
    ...
    @Override // extern.okio.BufferedSink, extern.okio.BufferedSource
    ...
    @Override // extern.okio.BufferedSink
    ...
    @Override // extern.okio.BufferedSink, extern.okio.Sink, java.io.Flushable
    public void flush() {
    }
    ...
    public OutputStream outputStream() {
        return new OutputStream() { // from class: extern.okio.Buffer.1
    ...
    @Override // extern.okio.BufferedSource
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: extern.okio.Buffer.2
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m562of(messageDigest.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m562of(mac.doFinal());
