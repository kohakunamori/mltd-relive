...
public final class Cache implements Closeable, Flushable {
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.internalCache = new InternalCache() { // from class: extern.okhttp3.Cache.1
            @Override // extern.okhttp3.internal.cache.InternalCache
    ...
    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() { // from class: extern.okhttp3.Cache.2
            boolean canRemove;
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor) {
            ...
            this.body = new ForwardingSink(this.cacheOut) { // from class: extern.okhttp3.Cache.CacheRequestImpl.1
        ...
        @Override // extern.okhttp3.internal.cache.CacheRequest
        public void abort() {
            synchronized (Cache.this) {
                if (this.done) {
                    return;
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m562of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(final DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.bodySource = Okio.buffer(new ForwardingSource(snapshot.getSource(1)) { // from class: extern.okhttp3.Cache.CacheResponseBody.1
