...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: extern.okhttp3.CipherSuite.1
    ...
    public static final CipherSuite TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = init("TLS_DHE_RSA_WITH_AES_128_CBC_SHA256", Quests.SELECT_RECENTLY_FAILED);
