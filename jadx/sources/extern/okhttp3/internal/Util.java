...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator<String>() { // from class: extern.okhttp3.internal.Util.1
    ...
    public static ThreadFactory threadFactory(final String str, final boolean z) {
        return new ThreadFactory() { // from class: extern.okhttp3.internal.Util.2
    ...
    /* JADX WARN: Code duplicated, block: B:35:0x005c A[LOOP:1: B:31:0x004f->B:35:0x005c, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:62:0x0062 A[EDGE_INSN: B:62:0x0062->B:36:0x0062 BREAK  A[LOOP:1: B:31:0x004f->B:35:0x005c], SYNTHETIC] */
    @Nullable
    private static InetAddress decodeIpv6(String str, int i, int i2) {
        ...
        if (i5 != bArr.length) {
            ...
            int i10 = i5 - i6;
            System.arraycopy(bArr, i6, bArr, bArr.length - i10, i10);
            Arrays.fill(bArr, i6, (bArr.length - i5) + i6, (byte) 0);
        }
        try {
