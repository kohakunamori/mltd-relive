...
final class Hpack {
    ...
    static final class Reader {
        ...
        ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m562of(Huffman.get().decode(this.source.readByteArray(i2)));
            }
