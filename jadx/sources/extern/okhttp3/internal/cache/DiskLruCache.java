...
import extern.okhttp3.internal.p002io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() { // from class: extern.okhttp3.internal.cache.DiskLruCache.1
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile)) { // from class: extern.okhttp3.internal.cache.DiskLruCache.2
            static final /* synthetic */ boolean $assertionsDisabled = false;

            @Override // extern.okhttp3.internal.cache.FaultHidingSink
    ...
    public synchronized Iterator<Snapshot> snapshots() throws IOException {
        initialize();
        return new Iterator<Snapshot>() { // from class: extern.okhttp3.internal.cache.DiskLruCache.3
    ...
    public final class Editor {
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                ...
                try {
                    return new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) { // from class: extern.okhttp3.internal.cache.DiskLruCache.Editor.1
                        @Override // extern.okhttp3.internal.cache.FaultHidingSink
                        protected void onException(IOException iOException) {
                            synchronized (DiskLruCache.this) {
                                Editor.this.detach();
