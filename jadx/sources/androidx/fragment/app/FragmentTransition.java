...
class FragmentTransition {
    ...
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, BackStackRecord.C0087Op c0087Op, SparseArray<FragmentContainerTransition> sparseArray, boolean z, boolean z2) {
        int i;
        boolean z3;
        boolean z4;
        boolean z5;
        ...
        int i2 = z ? INVERSE_OPS[c0087Op.cmd] : c0087Op.cmd;
        boolean z8 = false;
        if (i2 != 1) {
            switch (i2) {
                case 3:
