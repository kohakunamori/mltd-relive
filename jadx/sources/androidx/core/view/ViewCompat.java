...
public class ViewCompat {
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map arrayMap = (Map) view.getTag(C0043R.id.tag_unhandled_key_listeners);
            if (arrayMap == null) {
                arrayMap = new ArrayMap();
                view.setTag(C0043R.id.tag_unhandled_key_listeners, arrayMap);
            }
        ...
        ArrayList arrayList = (ArrayList) view.getTag(C0043R.id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            view.setTag(C0043R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static void removeOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            Map map = (Map) view.getTag(C0043R.id.tag_unhandled_key_listeners);
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m4at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0043R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0043R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
