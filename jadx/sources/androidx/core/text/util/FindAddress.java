...
class FindAddress {
    ...
    private static boolean checkHouseNumber(String str) {
        ...
        switch (i3 % 10) {
            case 1:
                return lowerCase.equals(i3 % 100 == 11 ? "th" : "st");
            case 2:
                return lowerCase.equals(i3 % 100 == 12 ? "th" : "nd");
            case 3:
                return lowerCase.equals(i3 % 100 == 13 ? "th" : "rd");
            default:
    ...
    private static int attemptMatch(String str, MatchResult matchResult) {
        ...
        while (iEnd < str.length()) {
            ...
            while (iEnd < matcher.start()) {
                int i4 = iEnd + 1;
                if (f5NL.indexOf(str.charAt(iEnd)) != -1) {
                    i++;
                }
                iEnd = i4;
            }
