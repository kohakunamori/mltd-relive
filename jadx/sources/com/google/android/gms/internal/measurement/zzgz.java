...
final class zzgz {
    ...
    static int zzc(int i, List<?> list) {
        ...
        if (list instanceof zzfp) {
            ...
            while (i2 < size) {
                ...
                if (objZzbw instanceof zzdp) {
                    iZzds2 = zzee.zzb((zzdp) objZzbw);
                } else {
                    iZzds2 = zzee.zzds((String) objZzbw);
                }
                iZzbi += iZzds2;
                i2++;
            }
            ...
            while (i2 < size) {
                ...
                if (obj instanceof zzdp) {
                    iZzds = zzee.zzb((zzdp) obj);
                } else {
                    iZzds = zzee.zzds((String) obj);
                }
                iZzbi += iZzds;
                i2++;
            }
    ...
    static int zzc(int i, List<?> list, zzgx zzgxVar) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            Object obj = list.get(i2);
            if (obj instanceof zzfn) {
                iZzb = zzee.zza((zzfn) obj);
            } else {
                iZzb = zzee.zzb((zzgi) obj, zzgxVar);
            }
            iZzbi += iZzb;
        }
        return iZzbi;
        ...
        if (list instanceof RandomAccess) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (zzfeVar.zzg(iIntValue)) {
                    ...
                    ub2 = (UB) zza(i, iIntValue, ub2, zzhpVar);
                }
            }
            if (i2 != size) {
            ...
            loop1: while (true) {
                ...
                while (it.hasNext()) {
                    ...
                    if (!zzfeVar.zzg(iIntValue2)) {
                        ub = (UB) zza(i, iIntValue2, ub2, zzhpVar);
                        it.remove();
                    }
                }
                break loop1;
