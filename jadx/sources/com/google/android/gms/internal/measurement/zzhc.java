...
class zzhc<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    public void zzry() {
        ...
        if (this.zzalm.isEmpty()) {
            ...
            mapUnmodifiableMap = Collections.unmodifiableMap(this.zzalm);
        }
        this.zzalm = mapUnmodifiableMap;
        if (this.zzalo.isEmpty()) {
            mapUnmodifiableMap2 = Collections.emptyMap();
        } else {
            mapUnmodifiableMap2 = Collections.unmodifiableMap(this.zzalo);
        }
        this.zzalo = mapUnmodifiableMap2;
        this.zzaey = true;
    }
    ...
    public V get(Object obj) {
        ...
        if (iZza >= 0) {
            return (V) this.zzall.get(iZza).getValue();
        }
    ...
    public final V put(K k, V v) {
        ...
        if (this.zzall.size() == this.zzalk) {
            zzhh zzhhVarRemove = this.zzall.remove(this.zzalk - 1);
