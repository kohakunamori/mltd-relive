...
import com.google.android.gms.base.C0300R;
import com.google.android.gms.common.C0301R;
...
public final class ConnectionErrorMessages {
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0300R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0300R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0300R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
                return null;
            case 5:
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return errorTitle == null ? context.getResources().getString(C0300R.string.common_google_play_services_notification_ticker) : errorTitle;
    }
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 9) {
            return resources.getString(C0300R.string.common_google_play_services_unsupported_text, appName);
        }
        if (i != 20) {
            switch (i) {
                case 1:
                    return resources.getString(C0300R.string.common_google_play_services_install_text, appName);
                case 2:
                    return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C0300R.string.common_google_play_services_wear_update_text) : resources.getString(C0300R.string.common_google_play_services_update_text, appName);
                case 3:
                    return resources.getString(C0300R.string.common_google_play_services_enable_text, appName);
                default:
                    switch (i) {
                        case 16:
                        ...
                        case 18:
                            return resources.getString(C0300R.string.common_google_play_services_updating_text, appName);
                        default:
                            return resources.getString(C0301R.string.common_google_play_services_unknown_issue, appName);
                    }
            }
        }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0300R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0300R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0300R.string.common_google_play_services_enable_button);
            default:
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (strZaa == null) {
            strZaa = resources.getString(C0301R.string.common_google_play_services_unknown_issue);
        }
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C0300R.string.common_google_play_services_notification_channel_name);
    }
