...
public class LibraryVersion {
    ...
    public String getVersion(@NonNull String str) {
        ...
        try {
            ...
            if (resourceAsStream != null) {
                ...
                try {
                    ...
                    sb.append(property);
                    gmsLogger.m18v("LibraryVersion", sb.toString());
                    str2 = property;
                } catch (IOException e) {
                    str2 = property;
                    e = e;
                    ...
                    gmsLogger2.m15e("LibraryVersion", strValueOf.length() != 0 ? "Failed to get app version for libraryName: ".concat(strValueOf) : new String("Failed to get app version for libraryName: "), e);
                }
            } else {
                GmsLogger gmsLogger3 = zzel;
                String strValueOf2 = String.valueOf(str);
                gmsLogger3.m14e("LibraryVersion", strValueOf2.length() != 0 ? "Failed to get app version for libraryName: ".concat(strValueOf2) : new String("Failed to get app version for libraryName: "));
            }
        ...
        if (str2 == null) {
            str2 = "UNKNOWN";
            zzel.m12d("LibraryVersion", ".properties file is dropped during release process. Failure to read app version isexpected druing Google internal testing where locally-built libraries are used");
        }
