...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m22id = 2)
    private final int zzh;

    @SafeParcelable.Field(getter = "getResolution", m22id = 3)
    private final PendingIntent zzi;

    @SafeParcelable.Field(getter = "getErrorMessage", m22id = 4)
    ...
    ConnectionResult(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) int i2, @SafeParcelable.Param(m23id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m23id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
