...
public final class zzk extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAllowTestKeys", m22id = 3)
    private final boolean zzaa;

    @SafeParcelable.Field(defaultValue = "false", getter = "getForbidTestKeys", m22id = 4)
    private final boolean zzab;

    @SafeParcelable.Field(getter = "getCallingPackage", m22id = 1)
    private final String zzy;

    @Nullable
    @SafeParcelable.Field(getter = "getCallingCertificateBinder", m22id = 2, type = "android.os.IBinder")
    private final zze zzz;

    @SafeParcelable.Constructor
    zzk(@SafeParcelable.Param(m23id = 1) String str, @SafeParcelable.Param(m23id = 2) @Nullable IBinder iBinder, @SafeParcelable.Param(m23id = 3) boolean z, @SafeParcelable.Param(m23id = 4) boolean z2) {
        this.zzy = str;
