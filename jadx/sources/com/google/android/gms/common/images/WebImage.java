...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", m22id = 3)
    private final int zane;

    @SafeParcelable.Field(getter = "getHeight", m22id = 4)
    private final int zanf;

    @SafeParcelable.Field(getter = "getUrl", m22id = 2)
    private final Uri zang;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) Uri uri, @SafeParcelable.Param(m23id = 3) int i2, @SafeParcelable.Param(m23id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
