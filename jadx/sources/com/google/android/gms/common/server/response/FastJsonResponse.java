...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Field(getter = "getTypeIn", m22id = 2)
        protected final int zapr;

        @SafeParcelable.Field(getter = "isTypeInArray", m22id = 3)
        protected final boolean zaps;

        @SafeParcelable.Field(getter = "getTypeOut", m22id = 4)
        protected final int zapt;

        @SafeParcelable.Field(getter = "isTypeOutArray", m22id = 5)
        protected final boolean zapu;

        @SafeParcelable.Field(getter = "getOutputFieldName", m22id = 6)
        protected final String zapv;

        @SafeParcelable.Field(getter = "getSafeParcelableFieldId", m22id = 7)
        protected final int zapw;
        protected final Class<? extends FastJsonResponse> zapx;

        @SafeParcelable.Field(getter = "getConcreteTypeName", m22id = 8)
        private final String zapy;
        private zak zapz;

        @SafeParcelable.Field(getter = "getWrappedConverter", m22id = 9, type = "com.google.android.gms.common.server.converter.ConverterWrapper")
        private FieldConverter<I, O> zaqa;

        @SafeParcelable.Constructor
        Field(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) int i2, @SafeParcelable.Param(m23id = 3) boolean z, @SafeParcelable.Param(m23id = 4) int i3, @SafeParcelable.Param(m23id = 5) boolean z2, @SafeParcelable.Param(m23id = 6) String str, @SafeParcelable.Param(m23id = 7) int i4, @SafeParcelable.Param(m23id = 8) String str2, @SafeParcelable.Param(m23id = 9) com.google.android.gms.common.server.converter.zaa zaaVar) {
            this.zalf = i;
            this.zapr = i2;
            this.zaps = z;
            this.zapt = i3;
