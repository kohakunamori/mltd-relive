...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.Field(getter = "getColumns", m22id = 1)
    private final String[] zalq;
    private Bundle zalr;

    @SafeParcelable.Field(getter = "getWindows", m22id = 2)
    private final CursorWindow[] zals;

    @SafeParcelable.Field(getter = "getStatusCode", m22id = 3)
    private final int zalt;

    @SafeParcelable.Field(getter = "getMetadata", m22id = 4)
    ...
    DataHolder(@SafeParcelable.Param(m23id = 1000) int i, @SafeParcelable.Param(m23id = 1) String[] strArr, @SafeParcelable.Param(m23id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(m23id = 3) int i2, @SafeParcelable.Param(m23id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
