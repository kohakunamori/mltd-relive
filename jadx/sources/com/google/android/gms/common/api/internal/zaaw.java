...
public final class zaaw extends GoogleApiClient implements zabt {
    ...
    public final ConnectionResult blockingConnect() {
        ...
        try {
            ...
            ConnectionResult connectionResultBlockingConnect = this.zagt.blockingConnect();
            this.zaeo.unlock();
    ...
    public final ConnectionResult blockingConnect(long j, @NonNull TimeUnit timeUnit) {
        ...
        try {
            ...
            zae(this.zahd.intValue());
            this.zags.enableCallbacks();
            ConnectionResult connectionResultBlockingConnect = this.zagt.blockingConnect(j, timeUnit);
            this.zaeo.unlock();
            return connectionResultBlockingConnect;
        } catch (Throwable th) {
            this.zaeo.unlock();
