...
public final class zzai extends AbstractSafeParcelable {
    ...
    public zzai(@SafeParcelable.Param(m23id = 2) String str, @SafeParcelable.Param(m23id = 3) zzah zzahVar, @SafeParcelable.Param(m23id = 4) String str2, @SafeParcelable.Param(m23id = 5) long j) {
        this.name = str;
        this.zzfq = zzahVar;
        this.origin = str2;
        this.zzfu = j;
