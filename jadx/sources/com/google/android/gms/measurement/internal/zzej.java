...
public final class zzej extends zzjh {
    ...
    @WorkerThread
    public static byte[] zza(HttpURLConnection httpURLConnection) throws Throwable {
        Throwable th;
    ...
    protected final HttpURLConnection zza(URL url) throws IOException {
        ...
        if (this.zzku != null && (uRLConnectionOpenConnection instanceof HttpsURLConnection)) {
            ((HttpsURLConnection) uRLConnectionOpenConnection).setSSLSocketFactory(this.zzku);
        }
