...
public final class zzjn extends AbstractSafeParcelable {
    ...
    zzjn(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) String str, @SafeParcelable.Param(m23id = 3) long j, @SafeParcelable.Param(m23id = 4) Long l, @SafeParcelable.Param(m23id = 5) Float f, @SafeParcelable.Param(m23id = 6) String str2, @SafeParcelable.Param(m23id = 7) String str3, @SafeParcelable.Param(m23id = 8) Double d) {
        this.versionCode = i;
        this.name = str;
        this.zztr = j;
        this.zzts = l;
