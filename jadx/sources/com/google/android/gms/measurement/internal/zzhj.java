        ...
        try {
            try {
                ...
                if (data != null && data.isHierarchical()) {
                    ...
                    if (this.zzpt.zzad().zza(zzak.zzje) || this.zzpt.zzad().zza(zzak.zzjg)) {
                        if (!TextUtils.isEmpty(queryParameter)) {
                            if (!queryParameter.contains("gclid") && !queryParameter.contains("utm_campaign") && !queryParameter.contains("utm_source") && !queryParameter.contains("utm_medium")) {
                                ...
                                bundleZza = zzjsVarZzz.zza(Uri.parse(strValueOf.length() != 0 ? "https://google.com/search?".concat(strValueOf) : new String("https://google.com/search?")));
                                if (bundleZza != null) {
                    ...
                    boolean z = false;
                    if (bundle == null && (bundleZza2 = this.zzpt.zzz().zza(data)) != null) {
                        bundleZza2.putString("_cis", "intent");
                        if (this.zzpt.zzad().zza(zzak.zzje) && !bundleZza2.containsKey("gclid") && bundleZza != null && bundleZza.containsKey("gclid")) {
                            bundleZza2.putString("_cer", String.format("gclid=%s", bundleZza.getString("gclid")));
                        }
                        this.zzpt.logEvent(str, "_cmp", bundleZza2);
                    }
                    if (this.zzpt.zzad().zza(zzak.zzjg) && bundleZza != null && bundleZza.containsKey("gclid") && (bundleZza2 == null || !bundleZza2.containsKey("gclid"))) {
                        this.zzpt.zzb("auto", "_lgclid", (Object) bundleZza.getString("gclid"), true);
                    }
                    if (TextUtils.isEmpty(queryParameter)) {
                        return;
                    }
