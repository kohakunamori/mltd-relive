...
final class zzx extends zzjh {
    ...
    public final List<zzq> zzb(String str, String[] strArr) throws Throwable {
        Cursor cursorQuery;
        zzo();
        zzbi();
        ArrayList arrayList = new ArrayList();
        ...
        try {
            try {
                ...
                try {
                    ...
                    List<zzq> listEmptyList = Collections.emptyList();
                    if (cursor != null) {
                        cursor.close();
                    }
    ...
    @WorkerThread
    public final zzw zza(long j, String str, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) throws Throwable {
        Cursor cursorQuery;
        Preconditions.checkNotEmpty(str);
        zzo();
        zzbi();
    ...
    @WorkerThread
    public final List<Pair<com.google.android.gms.internal.measurement.zzbs.zzg, Long>> zza(String str, int i, int i2) throws Throwable {
        Cursor cursorQuery;
        zzo();
        zzbi();
    ...
    final void zzb(List<Long> list) {
        ...
        if (zzcg()) {
            ...
            try {
                SQLiteDatabase writableDatabase = getWritableDatabase();
                StringBuilder sb3 = new StringBuilder(String.valueOf(string).length() + Notifications.NOTIFICATION_TYPES_ALL);
    ...
    public final long zzcf() throws Throwable {
        Cursor cursor = null;
        try {
            try {
                Cursor cursorRawQuery = getWritableDatabase().rawQuery("select rowid from raw_events order by rowid desc limit 1;", null);
                try {
                    if (!cursorRawQuery.moveToFirst()) {
                        if (cursorRawQuery != null) {
                            cursorRawQuery.close();
