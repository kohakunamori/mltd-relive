...
public final class zah extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", m22id = 2)
    private final ResolveAccountRequest zasd;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zalf = i;
