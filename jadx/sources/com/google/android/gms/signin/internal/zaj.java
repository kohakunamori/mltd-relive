...
public final class zaj extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", m22id = 2)
    private final ConnectionResult zadi;

    @SafeParcelable.VersionField(m24id = 1)
    private final int zalf;

    @SafeParcelable.Field(getter = "getResolveAccountResponse", m22id = 3)
    private final ResolveAccountResponse zase;

    @SafeParcelable.Constructor
    zaj(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) ConnectionResult connectionResult, @SafeParcelable.Param(m23id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
