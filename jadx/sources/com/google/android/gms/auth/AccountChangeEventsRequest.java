...
public class AccountChangeEventsRequest extends AbstractSafeParcelable {
    ...
    AccountChangeEventsRequest(@SafeParcelable.Param(m23id = 1) int i, @SafeParcelable.Param(m23id = 2) int i2, @SafeParcelable.Param(m23id = 3) String str, @SafeParcelable.Param(m23id = 4) Account account) {
        this.zze = i;
        this.zzi = i2;
        this.zzg = str;
