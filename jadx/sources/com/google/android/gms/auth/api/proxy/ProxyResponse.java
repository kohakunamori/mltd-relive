...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    ProxyResponse(@SafeParcelable.Param(m23id = 1000) int i, @SafeParcelable.Param(m23id = 1) int i2, @SafeParcelable.Param(m23id = 2) PendingIntent pendingIntent, @SafeParcelable.Param(m23id = 3) int i3, @SafeParcelable.Param(m23id = 4) Bundle bundle, @SafeParcelable.Param(m23id = 5) byte[] bArr) {
        this.versionCode = i;
