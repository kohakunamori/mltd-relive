...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValue = "", m22id = 4)
    @Deprecated
    private String zzba;

    @SafeParcelable.Field(getter = "getGoogleSignInAccount", m22id = 7)
    private GoogleSignInAccount zzbb;

    @SafeParcelable.Field(defaultValue = "", m22id = 8)
    @Deprecated
    private String zzbc;

    @SafeParcelable.Constructor
    SignInAccount(@SafeParcelable.Param(m23id = 4) String str, @SafeParcelable.Param(m23id = 7) GoogleSignInAccount googleSignInAccount, @SafeParcelable.Param(m23id = 8) String str2) {
