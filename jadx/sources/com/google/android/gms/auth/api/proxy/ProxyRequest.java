...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    ProxyRequest(@SafeParcelable.Param(m23id = 1000) int i, @SafeParcelable.Param(m23id = 1) String str, @SafeParcelable.Param(m23id = 2) int i2, @SafeParcelable.Param(m23id = 3) long j, @SafeParcelable.Param(m23id = 4) byte[] bArr, @SafeParcelable.Param(m23id = 5) Bundle bundle) {
        this.versionCode = i;
        this.url = str;
        this.httpMethod = i2;
