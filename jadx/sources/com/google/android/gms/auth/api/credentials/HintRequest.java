...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", m22id = 4)
    ...
    @SafeParcelable.Field(getter = "getHintPickerConfig", m22id = 1)
    private final CredentialPickerConfig zzah;

    @SafeParcelable.Field(getter = "isEmailAddressIdentifierSupported", m22id = 2)
    private final boolean zzai;

    @SafeParcelable.Field(getter = "isPhoneNumberIdentifierSupported", m22id = 3)
    ...
    HintRequest(@SafeParcelable.Param(m23id = 1000) int i, @SafeParcelable.Param(m23id = 1) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(m23id = 2) boolean z, @SafeParcelable.Param(m23id = 3) boolean z2, @SafeParcelable.Param(m23id = 4) String[] strArr, @SafeParcelable.Param(m23id = 5) boolean z3, @SafeParcelable.Param(m23id = 6) String str, @SafeParcelable.Param(m23id = 7) String str2) {
        this.zzu = i;
