...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getAccountTypes", m22id = 2)
    private final String[] zzaa;

    @SafeParcelable.Field(getter = "getCredentialPickerConfig", m22id = 3)
    private final CredentialPickerConfig zzab;

    @SafeParcelable.Field(getter = "getCredentialHintPickerConfig", m22id = 4)
    private final CredentialPickerConfig zzac;

    @SafeParcelable.Field(getter = "isIdTokenRequested", m22id = 5)
    private final boolean zzad;

    @SafeParcelable.Field(getter = "getServerClientId", m22id = 6)
    private final String zzae;

    @SafeParcelable.Field(getter = "getIdTokenNonce", m22id = 7)
    private final String zzaf;

    @SafeParcelable.Field(getter = "getRequireUserMediation", m22id = 8)
    private final boolean zzag;

    @SafeParcelable.Field(m22id = 1000)
    private final int zzu;

    @SafeParcelable.Field(getter = "isPasswordLoginSupported", m22id = 1)
    private final boolean zzz;

    @SafeParcelable.Constructor
    CredentialRequest(@SafeParcelable.Param(m23id = 1000) int i, @SafeParcelable.Param(m23id = 1) boolean z, @SafeParcelable.Param(m23id = 2) String[] strArr, @SafeParcelable.Param(m23id = 3) CredentialPickerConfig credentialPickerConfig, @SafeParcelable.Param(m23id = 4) CredentialPickerConfig credentialPickerConfig2, @SafeParcelable.Param(m23id = 5) boolean z2, @SafeParcelable.Param(m23id = 6) String str, @SafeParcelable.Param(m23id = 7) String str2, @SafeParcelable.Param(m23id = 8) boolean z3) {
        this.zzu = i;
        this.zzz = z;
