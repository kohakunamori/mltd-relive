...
public final class GamesClientStatusCodes extends CommonStatusCodes {
                                                                                                        ...
                                                                                                        switch (i) {
                                                                                                            ...
                                                                                                            default:
                                                                                                                switch (i) {
                                                                                                                    ...
                                                                                                                    default:
                                                                                                                        switch (i) {
                                                                                                                            case FTPReply.UNRECOGNIZED_COMMAND /* 500 */:
                                                                                                                                return 26520;
    ...
    public static Status zzb(Status status) {
        ...
        int iZzb = zzb(statusCode);
        if (iZzb == status.getStatusCode()) {
            return status;
        }
        if (GamesStatusCodes.getStatusString(status.getStatusCode()).equals(status.getStatusMessage())) {
            return new Status(iZzb, getStatusCodeString(iZzb), status.getResolution());
        }
        switch (statusCode) {
            case 2:
            case 3:
            ...
            case 9:
            default:
                return new Status(iZzb, status.getStatusMessage(), status.getResolution());
        }
    }
}
