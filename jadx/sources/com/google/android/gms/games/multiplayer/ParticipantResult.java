...
public final class ParticipantResult extends com.google.android.gms.games.internal.zzd {
    ...
    @SafeParcelable.Field(getter = "getResult", m22id = 2)
    private final int zzpm;

    @SafeParcelable.Field(getter = "getPlacing", m22id = 3)
    private final int zzpn;

    @SafeParcelable.Constructor
    public ParticipantResult(@SafeParcelable.Param(m23id = 1) String str, @SafeParcelable.Param(m23id = 2) int i, @SafeParcelable.Param(m23id = 3) int i2) {
        boolean z;
