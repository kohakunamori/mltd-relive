...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            ...
            this.f17bb.clear();
            this.f17bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f17bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f17bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f17bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
        this.finished = false;
        this.object_start = 0;
    ...
    public int offset() {
        return this.f17bb.capacity() - this.space;
    }
    ...
    public void prep(int i, int i2) {
        ...
        int iCapacity = ((((this.f17bb.capacity() - this.space) + i2) ^ (-1)) + 1) & (i - 1);
        while (this.space < iCapacity + i + i2) {
            int iCapacity2 = this.f17bb.capacity();
            ByteBuffer byteBuffer = this.f17bb;
            this.f17bb = growByteBuffer(byteBuffer, this.bb_factory);
            if (byteBuffer != this.f17bb) {
                this.bb_factory.releaseByteBuffer(byteBuffer);
            }
            this.space += this.f17bb.capacity() - iCapacity2;
        }
        pad(iCapacity);
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f17bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f17bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f17bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f17bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endObject() {
        ...
        int i3 = i2 + 1;
        while (i2 >= 0) {
            addShort((short) (this.vtable[i2] != 0 ? iOffset - this.vtable[i2] : 0));
            i2--;
        }
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f17bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f17bb.getShort(iCapacity);
            if (s == this.f17bb.getShort(i5)) {
                int i6 = 2;
                while (true) {
                    if (i6 < s) {
                        if (this.f17bb.getShort(iCapacity + i6) != this.f17bb.getShort(i5 + i6)) {
                            break;
                        }
                        i6 += 2;
                    } else {
        ...
        if (i != 0) {
            this.space = this.f17bb.capacity() - iOffset;
            this.f17bb.putInt(this.space, i - iOffset);
        } else {
            ...
            iArr[i7] = offset();
            this.f17bb.putInt(this.f17bb.capacity() - iOffset, offset() - iOffset);
        }
        this.nested = false;
        return iOffset;
    }
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f17bb.capacity() - i;
        if (this.f17bb.getShort((iCapacity - this.f17bb.getInt(iCapacity)) + i2) != 0) {
            return;
        }
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f17bb.capacity() - this.space);
        }
        this.f17bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f17bb.position(i);
        this.f17bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f17bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f17bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f17bb.capacity());
