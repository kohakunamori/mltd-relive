...
public final class FirebaseAnalytics {
    ...
    public final void logEvent(@NonNull @Size(max = 40, min = 1) String str, @Nullable Bundle bundle) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zza(WebviewObjectSettings.URLSCHEME_TYPE_APPLICATION, str, bundle, true);
        }
    }
    ...
    public final void setUserProperty(@NonNull @Size(max = 24, min = 1) String str, @Nullable @Size(max = 36) String str2) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(WebviewObjectSettings.URLSCHEME_TYPE_APPLICATION, str, (Object) str2, false);
        }
    }
    ...
    public final void setUserId(@Nullable String str) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(WebviewObjectSettings.URLSCHEME_TYPE_APPLICATION, APEZProvider.FILEID, (Object) str, true);
        }
    }
    ...
    public final String zzi() {
        ...
        synchronized (this.zzabx) {
            if (this.zzl) {
                ...
                jElapsedRealtime = this.zzj.zzx().elapsedRealtime();
            }
            if (Math.abs(jElapsedRealtime - this.zzabw) >= 1000) {
                return null;
            }
            return this.zzabv;
        }
