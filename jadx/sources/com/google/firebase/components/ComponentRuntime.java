...
public class ComponentRuntime extends AbstractComponentContainer {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = ComponentRuntime$$Lambda$3.instance;
    ...
    public ComponentRuntime(Executor executor, Iterable<ComponentRegistrar> iterable, Component<?>... componentArr) {
        ...
        arrayList.add(Component.m44of(this.eventBus, EventBus.class, Subscriber.class, Publisher.class));
