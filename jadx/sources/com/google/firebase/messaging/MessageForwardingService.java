...
public class MessageForwardingService extends IntentService {
    ...
    static void handleIntent(Context context, Intent intent, MessageWriter messageWriter) throws Throwable {
        String action;
        if (intent == null) {
            action = "null intent";
        } else {
        ...
        String strValueOf2 = String.valueOf(extras == null ? "(null)" : extras.toString());
