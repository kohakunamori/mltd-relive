...
public final class SerializedMessage extends Table {
    ...
    public void __init(int i, ByteBuffer byteBuffer) {
        this.bb_pos = i;
        this.f19bb = byteBuffer;
        this.vtable_start = this.bb_pos - this.f19bb.getInt(this.bb_pos);
        this.vtable_size = this.f19bb.getShort(this.vtable_start);
    }
    ...
    public DataPair data(DataPair dataPair, int i) {
        ...
        if (i__offset != 0) {
            return dataPair.__assign(__indirect(__vector(i__offset) + (i * 4)), this.f19bb);
        }
        return null;
    }
    ...
    public int timeToLive() {
        ...
        if (i__offset != 0) {
            return this.f19bb.getInt(i__offset + this.bb_pos);
        }
        return 0;
    }
    ...
    public SerializedNotification notification(SerializedNotification serializedNotification) {
        ...
        if (i__offset != 0) {
            return serializedNotification.__assign(__indirect(i__offset + this.bb_pos), this.f19bb);
        }
        return null;
    }
    ...
    public boolean notificationOpened() {
        ...
        return (i__offset == 0 || this.f19bb.get(i__offset + this.bb_pos) == 0) ? false : true;
    }
    ...
    public long sentTime() {
        ...
        if (i__offset != 0) {
            return this.f19bb.getLong(i__offset + this.bb_pos);
        }
        return 0L;
    }
