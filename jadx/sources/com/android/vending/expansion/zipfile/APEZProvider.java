...
public abstract class APEZProvider extends ContentProvider {
        ...
        if (!this.mInit) {
            ...
            try {
                ...
                if (providerInfoResolveContentProvider.metaData != null) {
                    i = providerInfoResolveContentProvider.metaData.getInt("mainVersion", i2);
                    i2 = providerInfoResolveContentProvider.metaData.getInt("patchVersion", i2);
                ...
                try {
                    if (strArr == null) {
                        this.mAPKExtensionFile = APKExpansionSupport.getAPKExpansionZipFile(context, i, i2);
                    } else {
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        if (this.mAPKExtensionFile == null) {
            ...
            allEntries = this.mAPKExtensionFile.getAllEntries();
        }
        if (strArr == null) {
            iArr = ALL_FIELDS_INT;
            strArr = ALL_FIELDS;
