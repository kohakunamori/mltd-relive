...
.method static clearCookieCache(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "UnityWebRequest: failed to parse URI %s"
...
.method private runSafe()V
    ...
    const-string v0, "WebRequest timed out."

    invoke-static {v2, v3, v8, v0}, Lcom/unity3d/player/UnityWebRequest;->errorCallback(JILjava/lang/String;)V
    ...
    invoke-virtual {v7, v10, v11, v9}, Ljava/io/OutputStream;->write([BII)V
    :try_end_2
    ...
    invoke-virtual {v1, v9, v10}, Lcom/unity3d/player/UnityWebRequest;->headerCallback(Ljava/lang/String;Ljava/lang/String;)V
    ...
    instance-of v9, v9, Ljava/net/CookieManager;
    ...
    check-cast v9, Ljava/net/CookieManager;
    ...
    invoke-direct {v13, v14, v15, v5, v4}, Ljava/net/URI;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v9, v13, v0}, Ljava/net/CookieStore;->add(Ljava/net/URI;Ljava/net/HttpCookie;)V
    :try_end_4
    ...
    const-string v11, "UnityWebRequest: error constructing URI: "
    ...
    const-string v13, "UnityWebRequest: error parsing cookie \'"
    ...
    invoke-static {v12, v0}, Lcom/unity3d/player/g;->Log(ILjava/lang/String;)V
...
.method protected badProtocolCallback(Ljava/lang/String;)V
    ...
    const-string v0, "UnityWebRequest: badProtocolCallback with error=%s url=%s"
...
.method protected errorCallback(Ljava/lang/String;)V
    ...
    const-string v0, "UnityWebRequest: errorCallback with error=%s url=%s"
    ...
    iget-object v3, p0, Lcom/unity3d/player/UnityWebRequest;->b:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v1, p1}, Lcom/unity3d/player/UnityWebRequest;->errorCallback(JILjava/lang/String;)V
...
.method protected malformattedUrlCallback(Ljava/lang/String;)V
    ...
    const-string v0, "UnityWebRequest: malformattedUrlCallback with error=%s url=%s"
...
.method protected sslCannotConnectCallback(Ljavax/net/ssl/SSLException;)V
    ...
    const-string v1, "UnityWebRequest: sslCannotConnectCallback with error=%s url=%s"
...
.method protected unknownHostCallback(Ljava/lang/String;)V
    ...
    const-string v0, "UnityWebRequest: unknownHostCallback with error=%s url=%s"
