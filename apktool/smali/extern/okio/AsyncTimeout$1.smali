...
.method public close()V
    ...
    invoke-virtual {v1, v0}, Lextern/okio/AsyncTimeout;->exit(Z)V
    ...
    invoke-virtual {v1, v0}, Lextern/okio/AsyncTimeout;->exit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {v1, v2}, Lextern/okio/AsyncTimeout;->exit(Z)V
...
.method public write(Lextern/okio/Buffer;J)V
    ...
    invoke-virtual {v3}, Lextern/okio/AsyncTimeout;->enter()V

    .line 180
    :try_start_0
    iget-object v3, p0, Lextern/okio/AsyncTimeout$1;->val$sink:Lextern/okio/Sink;

    invoke-interface {v3, p1, v0, v1}, Lextern/okio/Sink;->write(Lextern/okio/Buffer;J)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 184
    :try_start_1
    iget-object p2, p0, Lextern/okio/AsyncTimeout$1;->this$0:Lextern/okio/AsyncTimeout;

    invoke-virtual {p2, p1}, Lextern/okio/AsyncTimeout;->exit(Ljava/io/IOException;)Ljava/io/IOException;
    ...
    invoke-virtual {p2, v2}, Lextern/okio/AsyncTimeout;->exit(Z)V
