...
.method public close()V
    ...
    iget-wide v3, v3, Lextern/okio/Buffer;->size:J

    invoke-interface {v1, v2, v3, v4}, Lextern/okio/Sink;->write(Lextern/okio/Buffer;J)V
    :try_end_0
    ...
    invoke-interface {v1}, Lextern/okio/Sink;->close()V
    :try_end_1
    ...
    .line 252
    iput-boolean v1, p0, Lextern/okio/RealBufferedSink;->closed:Z

    if-eqz v0, :cond_3

    .line 254
    invoke-static {v0}, Lextern/okio/Util;->sneakyRethrow(Ljava/lang/Throwable;)V
...
.method public emitCompleteSegments()Lextern/okio/BufferedSink;
    ...
    invoke-virtual {v0}, Lextern/okio/Buffer;->completeSegmentByteCount()J
...
.method public flush()V
    ...
    iget-wide v2, v1, Lextern/okio/Buffer;->size:J
...
.method public write(Ljava/nio/ByteBuffer;)I
    ...
    invoke-virtual {v0, p1}, Lextern/okio/Buffer;->write(Ljava/nio/ByteBuffer;)I
...
.method public write(Lextern/okio/Source;J)Lextern/okio/BufferedSink;
    ...
    invoke-interface {p1, v0, p2, p3}, Lextern/okio/Source;->read(Lextern/okio/Buffer;J)J
...
.method public writeAll(Lextern/okio/Source;)J
    ...
    invoke-interface {p1, v2, v3, v4}, Lextern/okio/Source;->read(Lextern/okio/Buffer;J)J
