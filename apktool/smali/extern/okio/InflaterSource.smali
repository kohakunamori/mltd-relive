...
.method public constructor <init>(Lextern/okio/Source;Ljava/util/zip/Inflater;)V
    ...
    invoke-direct {p0, p1, p2}, Lextern/okio/InflaterSource;-><init>(Lextern/okio/BufferedSource;Ljava/util/zip/Inflater;)V
...
.method private releaseInflatedBytes()V
    ...
    .line 113
    iget v0, p0, Lextern/okio/InflaterSource;->bufferBytesHeldByInflater:I
    ...
    .line 114
    :cond_0
    iget-object v1, p0, Lextern/okio/InflaterSource;->inflater:Ljava/util/zip/Inflater;
...
.method public read(Lextern/okio/Buffer;J)J
    ...
    .line 58
    iget-boolean v2, p0, Lextern/okio/InflaterSource;->closed:Z
    ...
    .line 66
    :try_start_0
    invoke-virtual {p1, v1}, Lextern/okio/Buffer;->writableSegment(I)Lextern/okio/Segment;
    ...
    iget v5, v1, Lextern/okio/Segment;->limit:I
    ...
    .line 70
    iget p2, v1, Lextern/okio/Segment;->limit:I

    add-int/2addr p2, v2

    iput p2, v1, Lextern/okio/Segment;->limit:I

    .line 71
    iget-wide p2, p1, Lextern/okio/Buffer;->size:J

    int-to-long v0, v2

    add-long/2addr p2, v0

    iput-wide p2, p1, Lextern/okio/Buffer;->size:J
    ...
    .line 76
    iget p2, v1, Lextern/okio/Segment;->pos:I

    iget p3, v1, Lextern/okio/Segment;->limit:I

    if-ne p2, p3, :cond_5

    .line 78
    invoke-virtual {v1}, Lextern/okio/Segment;->pop()Lextern/okio/Segment;

    move-result-object p2

    iput-object p2, p1, Lextern/okio/Buffer;->head:Lextern/okio/Segment;

    .line 79
    invoke-static {v1}, Lextern/okio/SegmentPool;->recycle(Lextern/okio/Segment;)V
    :try_end_0
...
.method public final refill()Z
    ...
    iget v4, p0, Lextern/okio/InflaterSource;->bufferBytesHeldByInflater:I
