.class public final Lextern/okhttp3/internal/ws/WebSocketProtocol;
...
.method static toggleMask(Lextern/okio/Buffer$UnsafeCursor;[B)V
    .locals 7
    ...
    .line 99
    :cond_0
    iget-object v2, p0, Lextern/okio/Buffer$UnsafeCursor;->data:[B

    .line 100
    iget v3, p0, Lextern/okio/Buffer$UnsafeCursor;->start:I

    iget v4, p0, Lextern/okio/Buffer$UnsafeCursor;->end:I
    ...
    .line 104
    :cond_1
    invoke-virtual {p0}, Lextern/okio/Buffer$UnsafeCursor;->next()I
...
.method static validateCloseCode(I)V
    ...
    .line 118
    invoke-static {p0}, Lextern/okhttp3/internal/ws/WebSocketProtocol;->closeCodeExceptionMessage(I)Ljava/lang/String;
